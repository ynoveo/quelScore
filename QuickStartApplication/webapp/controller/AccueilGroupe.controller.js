...
onIDMatched: function(oEvent) {
			...
			var sUrl = sPreURL + "JSON_V2021.php?action=GRPLIST&isMember=X&email=" + sLogin + "&pass=" + sPass;
				...
				beginButton: new Button({
					...
					press: function () {
						...
						if(otModel.getProperty("/reponse/retcode") === "0") {
							...
							dialog.close();
							// refresh model
							sUrl = sPreURL + "JSON_V2021.php?action=GRPLIST&isMember=X&email=" + sLogin + "&pass=" + sPass;
							var oModel = new JSONModel();
							oModel.loadData(sUrl,{},false);
