...
// fin ajout JSPI 	
		...
		else if(pseudo==="Martine"){
			return "./avatars/Winner.png";	
		}
		else{
			if (avatar==="AUCUN"){
				return "";
...
onSecret: function () {
			...
			var pseudo=otModel.getProperty("/reponse/pseudo");
...
/*					buttons: new Button({
				...
				var sIdUser = ogModel.getProperty("/iduser");
				var sPseudo = ogModel.getProperty("/pseudo");
				sap.ui.core.UIComponent.getRouterFor(this).navTo("mesPronostics_card", { idUser: sIdUser, oPseudo: sPseudo});
