...
//
			...
			sap.ui.core.UIComponent.getRouterFor(this).getRoute("mesPronostics_card").attachPatternMatched(this.onUserMatched, this);
        ...
        handlePopoverPress: function (oEvent) {
           // var oCtx = oEvent.getSource().getBindingContext("remote"),
             var oButton = oEvent.getSource(),
				...
				if(String(id).indexOf("btn_stats_prono") === -1){
...
//						document.getElementById(this.createId("ifrm")).height = screen.height * 0.65;
						...
						document.getElementById(this.createId("ifrm")).src = "https://app.powerbi.com/view?r=eyJrIjoiMDBlOWU3NGYtZjczNC00MGFkLTg5MGItYTk3YTJiMmU0ZWE2IiwidCI6IjMwYTIxNTI4LTRkOTktNDFiOS05MzEwLTg2YjRkOTFlYThiNyIsImMiOjh9&pageName=ReportSection91d898c92c4eb910ff4e"
					}, this);
					/* 
					oPopover.modal = true;
					var that = this;
